...
public class CatHouse {
    ...
    public void rollCall() {
       if (cat1.getAge() > cat2.getAge()){
           ...
           cat2.introduce();
           cat1.introduce();
       } else if (cat1.getAge() == cat2.getAge() && cat1.getName() == cat2.getName()){
           cat1.introduce();
           cat2.introduce();
       }
       else {
           ...
           if (catName1.compareTo(catName2) <= 0){
               cat1.introduce();
               cat2.introduce();
           } else {
               cat2.introduce();
    ...
    public String houseInfo() {
        ...
        str += "Cat 1's Name: " + cat1.getName() + " Cat 1's Age: " + cat1.getAge()+ "\n";
        str += "Cat 2's Name: " + cat2.getName() + " Cat 2's Name: " + cat2.getAge();
        return str;
    }
}